...
Patch5:         0001-src-ui-frames.c-Fix-infinite-loop-if-style-has-multi.patch
...
%changelog
* Sun Apr  2 2017 Andrew Gunnerson <andrewgunnerson@gmail.com> - 3.22.3-2.1
- Fix typo that causes infinite loop if a theme has multiple variants
  Resolves: #1432699
